...
public class TeamSteps extends AndroidObject {
    ...
    public final HamburgerMenuPage Humburger;

    public final WellnessPage wellness;
    public final TeamPage team;

    public TeamSteps(RegistrationsPage regis, LoginPage log, Manager_HomePage ManHome, HamburgerMenuPage humburgerMenu, WellnessPage wellness, TeamPage team) {
...
//        this.hamburger = ham;
    ...
    public void pageDirectedToAddColleguePage() throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
    ...
    public void TeamNameUpdated() throws InterruptedException, MalformedURLException {
        ...
        System.out.println("Team name is updated from 'Learn Learning' to 'Learn'");
        Thread.sleep(4000);
    }
    ...
    public void userScrollDownTeam(String Team) throws InterruptedException {
        Thread.sleep(2000);
        team.scrollTillElement(Team);
        System.out.println("User scroll upto the created team");
    ...
    public void userClickOnMakeACapture() throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
        team.clickOnMakeAcaptue();
        System.out.println("user click on make a capture");
    }

    @When("user click on celebrate icon")
    public void clickOnCelebateIcon() throws InterruptedException, MalformedURLException {
        Thread.sleep(3000);
    ...
    public void userAcceotTheequestOfTeamInvitation() {
    ...
    public void userAbleToClickOnSetteingIcon() throws InterruptedException {
    ...
    public void userClickOnAddIcon() throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
        team.ClickOnAddMemebersBtn();
        team.clickOnAddColleagueToThisteam();
    }
    @When("user click on search or invite colleague{string}")
    public void UserClickOnSearchOrInviteColleage(String memberName) throws InterruptedException, MalformedURLException {
        Thread.sleep(4000);
    ...
    public void userClickOnInviteNowButtonOfInviteToTeam() throws MalformedURLException {
        team.clickonInviteNowAfterCollegue();
    }
    @And("user enter collegue email address{string}")
    public void enterCOllegueEmail(String Email) throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
    ...
    @When("user enter collegue name{string} in drop down search box")
    public void enterCollegueName(String name) throws MalformedURLException, InterruptedException {
    ...
    public void sendRequesttoCollegue() throws InterruptedException, MalformedURLException {
        Thread.sleep(2000);
        System.out.println("Request sent to the collegue");
    ...
    public void teamNameAndTeamMembersCountShouldBeDisplayed(String Team) throws MalformedURLException, InterruptedException {
        team.toSeeAcceptedAndInvitedColleagueCoundBelowTeamName(Team);
    }
