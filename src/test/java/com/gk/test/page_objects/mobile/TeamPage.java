...
public class TeamPage extends AndroidObject {
  ...
  //  static private final By clickOnteamName = By.xpath("//android.view.View[contains(@content-desc,'Learn Testing')]");
    ...
    public void clickOnMakeAcaptue() throws MalformedURLException {
    ...
    public void ClickOnAddMemebersBtn() throws MalformedURLException {
    ...
    public void clickonInviteNowAfterCollegue() throws MalformedURLException {
        applyWaitForElement(inviteNowAfterAddCollegue, 10);
        getAndroidDriver().findElement(inviteNowAfterAddCollegue).click();
        System.out.println("clicked on invite Now AfterAddCollegue ");
    }
    public void enterWorkEmail(String email) throws MalformedURLException, InterruptedException {
        ...
        System.out.println("Enter the collegue email ");
        Thread.sleep(2000);
    ...
    public void enterIntoSearchAnyone(String collegueName) throws MalformedURLException, InterruptedException {
        applyWaitForElement(searchForAnyoneTab, 10);
        getAndroidDriver().findElement(searchForAnyoneTab).click();
        Thread.sleep(1500);
        getAndroidDriver().findElement(searchForAnyoneTab).sendKeys(collegueName);
        System.out.println("Enter the collegue name ");
    ...
    public void toSeeAcceptedAndInvitedColleagueCoundBelowTeamName(String Team) throws InterruptedException, MalformedURLException {
        applyWaitForElement(By.xpath("//*[contains(@content-desc,'"+Team+"')]"), 10);
        Thread.sleep(3000);
